...
(defmacro with-debug-on-error (&rest body)
  `(let ((setq debug-on-error t))
     ,@body))
;(defvar simple '(1.0 2.0 3.0 4.0))
;(setf simple '(1.0 2.0 3.0 4.0))
;(setf rev-simple (reverse simple))
;(defvar rev-simple (reverse simple))
;(setf rand1 '(3.7 2.4 9.9 100.0))
;(defvar rand1 '(3.7 2.4 9.9 100.0))
;(setf rand2 '(5.5 8.6 7.5 0.01))
;(defvar rand2 '(5.5 8.6 7.5 0.01))
(defun lt (x y) (if (< x y)
                    1 0))
(defvar nl ";print \"\\n\"")
...
(defun make-sse-test ()
(let* ((simple '(1.0 2.0 3.0 4.0))
       (rev-simple (reverse simple))
       (rand1 '(3.7 2.4 9.9 100.0))
       (rand2 '(5.5 8.6 7.5 0.01)))
