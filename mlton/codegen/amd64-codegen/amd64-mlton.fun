...
(* | Simd_Word_abs s =>
   (case s of
      V128W16 => ... sse_abs (Instruction.SSE_ABS,"w")
     | V128W32 => ... sse_abs (Instruction.SSE_ABS,"d")
     | _ => Error.bug "amd64.mlton, unimplemented")*)
 | Simd_Word_add s =>
   (case s of
       V128W8 => sse_ibinap (Instruction.SSE_PADD,"b")
     | V128W16 => sse_ibinap (Instruction.SSE_PADD,"w")
     | V128W32 => sse_ibinap (Instruction.SSE_PADD,"d")
     | V128W64 => sse_ibinap (Instruction.SSE_PADD,"q")
     | _ => Error.bug "amd64.mlton, unimplemented")
(* | Simd_Word_adds (s,g) => 
   (case g of
        true => case s of(
 ...
 | Simd_Word_andb s =>
   (case s of
       V128W8 => sse_ibinlp (Instruction.SSE_PAND,"")
     | V128W16 => sse_ibinlp (Instruction.SSE_PAND,"")
     | V128W32 => sse_ibinlp (Instruction.SSE_PAND,"")
     | V128W64 => sse_ibinlp (Instruction.SSE_PAND,"")
     | _ => Error.bug "amd64.mlton, unimplemented")
 | Simd_Word_andnb s =>
   (case s of
       V128W8 => sse_ibinlp (Instruction.SSE_PANDN,"")
     | V128W16 => sse_ibinlp (Instruction.SSE_PANDN,"")
     | V128W32 => sse_ibinlp (Instruction.SSE_PANDN,"")
     | V128W64 => sse_ibinlp (Instruction.SSE_PANDN,"")
     | _ => Error.bug "amd64.mlton, unimplemented")
(* | Simd_Word_cmpeq s =>
   (case s of
       V128W8 => sse_cmpeq (Instruction.SSE_CMPEQ,"b")
     | V128W16 => sse_cmpeq (Instruction.SSE_CMPEQ,"w")
     | V128W32 => sse_cmpeq (Instruction.SSE_CMPEQ,"d")
     | V128W64 => sse_cmpeq (Instruction.SSE_CMPEQ,"q")
     | _ => Error.bug "amd64.mlton, unimplemented")
 | Simd_Word_cmpgt s =>
   (case s of
       V128W8 => sse_cmpgt (Instruction.SSE_CMPGT,"b")
     | V128W16 => sse_cmpgt (Instruction.SSE_CMPGT,"w")
     | V128W32 => sse_cmpgt (Instruction.SSE_CMPGT,"d")
     | V128W64 => sse_cmpgt (Instruction.SSE_CMPGT,"q")
     | _ => Error.bug "amd64.mlton, unimplemented")*)
 | Simd_Word_fromArray s =>
   (case s of
       V128W8 => sse_movp (Instruction.SSE_MOVDQA)
     | V128W16 => sse_movp (Instruction.SSE_MOVDQA)
     | V128W32 => sse_movp (Instruction.SSE_MOVDQA)
     | V128W64 => sse_movp (Instruction.SSE_MOVDQA)
     | _ => Error.bug "amd64.mlton, unimplemented")
(* | Simd_Word_fromScalar s =>
 ...
 | Simd_Word_hadd s =>
   (case s of
      V128W16 => ssse3_ibinap (Instruction.SSE_PHADD,"w")
     | V128W32 => ssse3_ibinap (Instruction.SSE_PHADD,"d")
     | _ => Error.bug "amd64.mlton, unimplemented")
 | Simd_Word_hsub s =>
   (case s of
      V128W16 => ssse3_ibinap (Instruction.SSE_PHSUB,"w")
...
(* | Simd_Word_mulhi (s,g) => true*)
 | Simd_Word_mullo s =>
   (case s of     
        V128W16 => sse_mullo (Instruction.SSE_mullo,"w")
      | _ => Error.bug "amd64.mlton, unimplemented")*)
 | Simd_Word_orb s =>
   (case s of
       V128W8 => sse_ibinlp (Instruction.SSE_POR,"")
     | V128W16 => sse_ibinlp (Instruction.SSE_POR,"")
     | V128W32 => sse_ibinlp (Instruction.SSE_POR,"")
     | V128W64 => sse_ibinlp (Instruction.SSE_POR,"")
     | _ => Error.bug "amd64.mlton, unimplemented")
 | Simd_Word_sar s =>
   (case s of
       V128W16 => sse_ibinlp (Instruction.SSE_PSRA,"w")
     | V128W32 => sse_ibinlp (Instruction.SSE_PSRA,"d")
     | _ => Error.bug "amd64.mlton, unimplemented")
(* | Simd_Word_sari s =>
   (case s of
       V128W8 => sse_sari (Instruction.SSE_sari,"b")
     | V128W16 => sse_sari (Instruction.SSE_sari,"w")
     | V128W32 => sse_sari (Instruction.SSE_sari,"d")
     | V128W64 => sse_sari (Instruction.SSE_sari,"q")
     | _ => Error.bug "amd64.mlton, unimplemented")*)
(* | Simd_Word_shuffle s =>
   (case s of
       V128W8 => sse_shuffle (Instruction.SSE_shuffle,"b")
     | V128W16 => sse_shuffle (Instruction.SSE_shuffle,"w")
     | V128W32 => sse_shuffle (Instruction.SSE_shuffle,"d")
     | V128W64 => sse_shuffle (Instruction.SSE_shuffle,"q")
     | _ => Error.bug "amd64.mlton, unimplemented")*)
 | Simd_Word_sll s =>
   (case s of
       V128W16 => sse_ibinlp (Instruction.SSE_PSLL,"w")
     | V128W32 => sse_ibinlp (Instruction.SSE_PSLL,"d")
     | V128W64 => sse_ibinlp (Instruction.SSE_PSLL,"q")
     | _ => Error.bug "amd64.mlton, unimplemented")
(* | Simd_Word_slli s =>
   (case s of
       V128W8 => sse_slli (Instruction.SSE_slli,"b")
     | V128W16 => sse_slli (Instruction.SSE_slli,"w")
     | V128W32 => sse_slli (Instruction.SSE_slli,"d")
     | V128W64 => sse_slli (Instruction.SSE_slli,"q")
     | _ => Error.bug "amd64.mlton, unimplemented")*)
 | Simd_Word_slr s =>
   (case s of
       V128W16 => sse_ibinlp (Instruction.SSE_PSRL,"w")
     | V128W32 => sse_ibinlp (Instruction.SSE_PSRL,"d")
     | V128W64 => sse_ibinlp (Instruction.SSE_PSRL,"q")
     | _ => Error.bug ("amd64.mlton, unimplemented")
(* | Simd_Word_slri s =>
   (case s of
       V128W8 => sse_slri (Instruction.SSE_slri,"b")
     | V128W16 => sse_slri (Instruction.SSE_slri,"w")
     | V128W32 => sse_slri (Instruction.SSE_slri,"d")
     | V128W64 => sse_slri (Instruction.SSE_slri,"q")*)
     | _ => Error.bug "amd64.mlton, unimplemented")
 | Simd_Word_sub s =>
   (case s of
       V128W8 => sse_ibinap (Instruction.SSE_PSUB,"b")
     | V128W16 => sse_ibinap (Instruction.SSE_PSUB,"w")
     | V128W32 => sse_ibinap (Instruction.SSE_PSUB,"d")
     | V128W64 => sse_ibinap (Instruction.SSE_PSUB,"q")
     | _ => Error.bug "amd64.mlton, unimplemented")
...
(* | Simd_Word_toScalar s =>
 ...
 | Simd_Word_xorb s =>
   (case s of
       V128W8 => sse_ibinlp (Instruction.SSE_PXOR,"")
     | V128W16 => sse_ibinlp (Instruction.SSE_PXOR,"")
     | V128W32 => sse_ibinlp (Instruction.SSE_PXOR,"")
     | V128W64 => sse_ibinlp (Instruction.SSE_PXOR,"")
     | _ => Error.bug "amd64.mlton, unimplemented")
