...
static const char* mlTypesHStd[] = {
  ...
  "typedef __m128i Simd128_Word8_t;",
  "typedef __m128i Simd128_Word16_t;",
  "typedef __m128i Simd128_Word32_t;",
  "typedef __m128i Simd128_Word64_t;",
  "typedef __m128i Simd128_WordX_t;",
  "typedef __m128i Simd128_Word8;",
  "typedef __m128i Simd128_Word16;",
  "typedef __m128i Simd128_Word32;",
  "typedef __m128i Simd128_Word64;",
  "#ifdef __AVX__",
...
/*NOTE: Unhygenic macros are confusing
 *Also what is bt, base type? */
...
/*type, basetype, subtype,name             *
 *ex. simdtype(__m128, Simd, Real32, SimdFloat)    */
/*if type != type t add
  writeString type t = simd
  writeString type e = toLower(et);*/
#define simdtype(t, bt, st, name)                       \
  do {                                                  \
  writeString (cTypesHFd, "typedef");                   \
  writeString (cTypesHFd, " /* ");                      \
  writeString (cTypesHFd, #t);                          \
  ...
  writeString (cTypesHFd, bt);                          \
  writeUintmaxU (cTypesHFd, CHAR_BIT * sizeof (t));     \
  writeString (cTypesHFd, "_");                         \
  writeString (cTypesHFd, st);                          \
  writeString (cTypesHFd, "_t");                        \
  writeString (cTypesHFd, " ");                         \
  writeString (cTypesHFd, "C_");                        \
  writeString (cTypesHFd, name);                        \
