...
structure Word128 =
   struct
      ...
      val sizeInBits: Int32.int = 128
      val sizeInBitsWord: Word32.word = 
         IntWordConv.zextdFromInt32ToWord32 sizeInBits

      val + = _prim "Word128_add": word * word -> word;
      val andb = _prim "Word128_andb": word * word -> word;
      val <<? = _prim "Word128_lshift": word * Word32.word -> word;
      val * = _prim "WordU128_mul": word * word -> word;
      val ~ = _prim "Word128_neg": word -> word;
      val notb = _prim "Word128_notb": word -> word;
      val orb = _prim "Word128_orb": word * word -> word;
      val quotUnsafe = _prim "WordU128_quot": word * word -> word;
      val remUnsafe = _prim "WordU128_rem": word * word -> word;
      val rolUnsafe = _prim "Word128_rol": word * Word32.word -> word;
      val rorUnsafe = _prim "Word128_ror": word * Word32.word -> word;
      val ~>>? = _prim "WordS128_rshift": word * Word32.word -> word;
      val >>? = _prim "WordU128_rshift": word * Word32.word -> word;
      val - = _prim "Word128_sub": word * word -> word;
      val xorb = _prim "Word128_xorb": word * word -> word;

      val < = _prim "WordU128_lt": word * word -> bool;
   end
structure Word256 =
   struct
      open Word256
      ...
      val + = _prim "Word256_add": word * word -> word;
      val andb = _prim "Word256_andb": word * word -> word;
      val <<? = _prim "Word256_lshift": word * Word32.word -> word;
      val * = _prim "WordU256_mul": word * word -> word;
      val ~ = _prim "Word256_neg": word -> word;
      val notb = _prim "Word256_notb": word -> word;
      val orb = _prim "Word256_orb": word * word -> word;
      val quotUnsafe = _prim "WordU256_quot": word * word -> word;
      val remUnsafe = _prim "WordU256_rem": word * word -> word;
      val rolUnsafe = _prim "Word256_rol": word * Word32.word -> word;
      val rorUnsafe = _prim "Word256_ror": word * Word32.word -> word;
      val ~>>? = _prim "WordS256_rshift": word * Word32.word -> word;
      val >>? = _prim "WordU256_rshift": word * Word32.word -> word;
      val - = _prim "Word256_sub": word * word -> word;
      val xorb = _prim "Word256_xorb": word * word -> word;

      val < = _prim "WordU256_lt": word * word -> bool;
   end
