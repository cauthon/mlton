...
"\nstructure %s : PRIM_SIMD_REAL =
  struct
    ...
    type elt = Real%d.real
      ...
      val toArray = _prim \"%s_toArray\": simd -> eltlem array
      val fromScalar = _prim \"%s_fromScalar\": elt -> simd
      val toScalar = _prim \"%s_toScalar\": simd -> elt
  end"
...
structure Simd128_Real64 : PRIM_SIMD_REAL =
  struct
    ...
    type simd = t
      ...
      val fromScalar = _prim "Simd128_Real64_fromScalar": elt -> simd ;
      val toScalar = _prim "Simd128_Real64_toScalar": simd -> elt ;
  end
structure Simd256_Real32 : PRIM_SIMD_REAL =
  struct
    ...
    type elt = Real32.real
      ...
      val fromScalar = _prim "Simd256_Real32_fromScalar": elt -> simd ;
      val toScalar = _prim "Simd256_Real32_toScalar": simd -> elt ;
  end
structure Simd256_Real64 : PRIM_SIMD_REAL =
  struct
    ...
    type elt = Real64.real
      ...
      val fromScalar = _prim "Simd256_Real64_fromScalar": elt -> simd ;
      val toScalar = _prim "Simd256_Real64_toScalar": simd -> elt ;
  end
