...
(*    type simd = t*)
      ...
      val fromArray = _prim "Simd128_Real32_load": elt array * Int64.int-> simdReal ;
...
(*    type simdReal = t*)
      ...
      val fromArray = _prim "Simd128_Real64_load": elt array * Int64.int -> simdReal ;
...
(*    type simd = t*)
      ...
      val fromArray = _prim "Simd256_Real32_load": elt array * Int64.int-> simdReal ;
...
(*    type simdReal = t*)
      ...
      val fromArray = _prim "Simd256_Real64_load": elt array * Int64.int -> simdReal ;
...
(*   fun unimp (name,size) =
  ...
  fun unimp _ = raise Unimplemented
 in
structure Simd128_Word8 : PRIM_SIMD_WORD =
   struct
      ...
      type elt = Word8.word
      type intElt = Int8.int
      val add = _prim "Simd128_Word8_add": simdWord * simdWord -> simdWord; (* b w d q *)
      val adds = _prim "Simd128_Word8_addss": simdWord * simdWord -> simdWord; (* b w *)
      val addus = _prim "Simd128_Word8_addsu": simdWord * simdWord -> simdWord; (* b w *)
...
structure Simd128_Word16 : PRIM_SIMD_WORD =
   struct
      ...
      type intElt = Int16.int
      val add = _prim "Simd128_Word16_add": simdWord * simdWord -> simdWord; (* b w d q *)
      val adds = _prim "Simd128_Word16_addss": simdWord * simdWord -> simdWord; (* b w *)
      val addus = _prim "Simd128_Word16_addsu": simdWord * simdWord -> simdWord; (* b w *)
...
structure Simd128_Word32 : PRIM_SIMD_WORD =
   struct
      ...
      val muluhi =  unimp()
      val mullo =  unimp()
      val mul32 = _prim "Simd128_Word32_mul32": simdWord * simdWord -> Simd128_Word64.simdWord; (*multiply odd elements of t,t and return t2 result, d*)
      ...
      val sari = _prim "Simd128_Word32_sari": simdWord * Word8.word -> simdWord;(*w d*)
      val slri = _prim "Simd128_Word32_slri": simdWord * Word8.word -> simdWord;(*w d q*)
      val slli = _prim "Simd128_Word32_slli": simdWord * Word8.word -> simdWord;(*w d q*)
      (*we can also logically shift a full 128bit vector left/right*)
      (*Comparison*)
      (*this is all we get for builtin integer comparison*)
...
(*      val mul32 =  unimp()*)
      ...
      val sari =  unimp()
      val slri = _prim "Simd128_Word64_slri": simdWord * Word8.word -> simdWord;(*w d q*)
      val slli = _prim "Simd128_Word64_slli": simdWord * Word8.word -> simdWord;(*w d q*)
      (*we can also logically shift a full 128bit vector left/right*)
      (*Comparison*)
      (*this is all we get for builtin integer comparison*)
...
(*structure Simd256_Word8 : PRIM_SIMD_WORD =
   struct
      ...
      val adds = _prim "Simd256_Word8_addss": simdWord * simdWord -> simdWord; (* b w *)
      val addus = _prim "Simd256_Word8_addsu": simdWord * simdWord -> simdWord; (* b w *)
      ...
      val hsub =   unimp()
      val hadd =  unimp()
      val abs = _prim "Simd256_Word8_abs": simdWord -> simdWord;(*b w*)
...
structure Simd256_Word16 : PRIM_SIMD_WORD =
   struct
      ...
      val adds = _prim "Simd256_Word16_addss": simdWord * simdWord -> simdWord; (* b w *)
      val addus = _prim "Simd256_Word16_addsu": simdWord * simdWord -> simdWord; (* b w *)
      val sub = _prim "Simd256_Word16_sub": simdWord * simdWord -> simdWord; (* b w d q *)
      val subs = _prim "Simd256_Word16_subss": simdWord * simdWord -> simdWord; (* b w *)
      val subus = _prim "Simd256_Word16_subsu": simdWord * simdWord -> simdWord; (* b w *)
      val minu = _prim "Simd256_Word16_minu": simdWord * simdWord -> simdWord; (* w, if sse4.1 then + b d *)
      val min = _prim "Simd256_Word16_mins": simdWord * simdWord -> simdWord; (* b, if sse4.1 then + w d *)
      val maxu = _prim "Simd256_Word16_maxu": simdWord * simdWord -> simdWord; (* w, if sse4.1 then + b d *)
      val max = _prim "Simd256_Word16_maxs": simdWord * simdWord -> simdWord; (* b, if sse4.1 then + w d *)

      val mulshi = _prim "Simd256_Word16_mulhis": simdWord * simdWord -> simdWord; (*mul signed high, w*)
      val muluhi = _prim "Simd256_Word16_mulhiu": simdWord * simdWord -> simdWord; (*mul unsigned high w*)
      ...
      val sari = _prim "Simd256_Word16_sari": simdWord * Word8.word -> simdWord;(*w d*)
      val slri = _prim "Simd256_Word16_slri": simdWord * Word8.word -> simdWord;(*w d q*)
      val slli = _prim "Simd256_Word16_slli": simdWord * Word8.word -> simdWord;(*w d q*)
...
structure Simd256_Word32 : PRIM_SIMD_WORD =
   struct
      ...
      val min = _prim "Simd256_Word32_mins": simdWord * simdWord -> simdWord; (* b, if sse4.1 then + w d *)
      val maxu = _prim "Simd256_Word32_maxu": simdWord * simdWord -> simdWord; (* w, if sse4.1 then + b d *)
      val max = _prim "Simd256_Word32_maxs": simdWord * simdWord -> simdWord; (* b, if sse4.1 then + w d *)

      val mulshi =  unimp()
      val muluhi =  unimp()
      val mullo =  unimp()
      val mul32 = _prim "Simd256_Word32_mul32": simdWord * simdWord -> Simd256_Word64.simdWord; (*multiply odd elements of t,t and return t2 result, d*)
      ...
      val sari = _prim "Simd256_Word32_sari": simdWord * Word8.word -> simdWord;(*w d*)
      val slri = _prim "Simd256_Word32_slri": simdWord * Word8.word -> simdWord;(*w d q*)
      val slli = _prim "Simd256_Word32_slli": simdWord * Word8.word -> simdWord;(*w d q*)
      (*we can also logically shift a full 256bit vector left/right*)
      (*Comparison*)
      (*this is all we get for builtin integer comparison*)
...
structure Simd256_Word64 : PRIM_SIMD_WORD =
   struct
      ...
      val sari =  unimp()
      val slri = _prim "Simd256_Word64_slri": simdWord * Word8.word -> simdWord;(*w d q*)
      val slli = _prim "Simd256_Word64_slli": simdWord * Word8.word -> simdWord;(*w d q*)
      (*we can also logically shift a full 256bit vector left/right*)
      (*Comparison*)
      (*this is all we get for builtin integer comparison*)
