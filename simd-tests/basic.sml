local
  ...
  val print_scalar = _import "Simd128_Real32_printScalar" : simdReal -> unit;
  ...
  val ss1:simdReal = fromScalar(scalar1)
  val ss2:simdReal = fromScalar(scalar2)
  fun print_test (s:simdReal,r:simdReal,scalar:simdReal,test:string)
